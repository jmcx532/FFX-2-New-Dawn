...
public partial class FormulasModule : FhModule
{
    ...
    public delegate int d_FUN_61B930(int chr_id1, int chr_id2, int cmd_base_addr, int cmd_dmg_formula, int power, int sc_gil,
            int param_7, int user_hp_remain, int user_hp_max, int param_10, int param_11, int tgt_hp_remain,
            int tgt_hp_max, int user_str, int user_str_mod, int user_mag, int user_mag_mod, int user_level,
    ...
    public unsafe int h_FUN_61B930(int user_chr_id, int tgt_chr_id, int cmd_base_addr, int cmd_dmg_formula, int power, int sc_gil,
            int param_7, int user_hp_remain, int user_hp_max, int param_10, int param_11, int tgt_hp_remain,
            int tgt_hp_max, int user_str, int user_str_mod, int user_mag, int user_mag_mod, int user_level,
            int tgt_def, int tgt_def_mod, int tgt_magdef, int tgt_magdef_mod)
    {
        ...
        is_enemy = h_MsGetRamChrMonster((byte)user_chr_id);
        //20, 21 or 22 for YRP
        iVar4 = user_chr_id + 0x14;
        if (is_enemy != 0)
        {
            //33, 34, 35
            iVar4 = user_chr_id + 0xd;
        }
        if (param_7 == 0)
        {
        ...
        user_ply_save_ptr = h_MsGetSavePlayerPtr((byte)user_chr_id);
        //this does soemthing for Damage Formula 13 (case 0xd:) - is some base address
        tgt_ply_save_ptr = h_MsGetSavePlayerPtr((byte)tgt_chr_id);
        ...
        switch (cmd_dmg_formula)
        {
            ...
            case 0x17:
                ...
                final_damage = (((((((int)((user_level >> 0x1f & 0x3ffU) + user_level) >> 10) + user_str) *
            ...
            case 1:
                user_level = (user_str + user_level) * user_str * user_level;
                power = (((((((((int)((user_level >> 0x1f & 0x3ffU) + user_level) >> 10) + user_str) * 0x10e) /
            ...
            //Magic formula
            case 2:
                power = (user_mag + user_level * 2) * power * power;
            ...
            case 9:
                ...
                final_damage = (((((((int)((user_level >> 0x1f & 0x3ffU) + user_level) >> 10) + user_mag) *
